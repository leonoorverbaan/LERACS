...
class RobotControlUI(customtkinter.CTk):
    ...
    def create_widgets(self):
        ...
        self.refresh_button = customtkinter.CTkButton(self.menu_frame, text="Refresh UI",
        ...
        self.content_frame = customtkinter.CTkFrame(self, width=750, height=700)
        ...
        self.robot_vision_label_frame = customtkinter.CTkFrame(self.content_frame, corner_radius=10)
        ...
        self.robot_vision_label = customtkinter.CTkLabel(self.robot_vision_label_frame, text="Robot Vision",
                                                         font=label_font)
        self.robot_vision_label.grid(row=0, column=0, padx=10, pady=5, sticky="ew")

        # Create a dark grey frame around the image
        self.image_frame = customtkinter.CTkFrame(self.content_frame, corner_radius=10)
        ...
        self.img_label = customtkinter.CTkLabel(self.image_frame, text="")  # Make label text empty
        self.img_label.grid(row=0, column=0, padx=10, pady=10, sticky="nsew")

        self.img_label_detected = customtkinter.CTkLabel(self.image_frame, text="")  # Make label text empty
        ...
        self.scrollable_frame = customtkinter.CTkScrollableFrame(self.content_frame, label_text="Chat Area", width=750,
                                                                 height=10, label_font=label_font)
        self.scrollable_frame.grid(row=2, column=0, pady=(5, 5), sticky="nsew")
        ...
        self.input_frame = customtkinter.CTkFrame(self.content_frame, height=40, corner_radius=10)
        self.input_frame.grid(row=3, column=0, pady=(0, 5), padx=10, sticky="ew")
        self.input_frame.grid_columnconfigure(0, weight=1)

        # Entry widget for user input
        self.user_input = ttk.Entry(self.input_frame, width=100)
        self.user_input.grid(row=0, column=0, padx=5, pady=5, sticky="ew")
    ...
    def refresh_ui(self):
        """Refresh the UI by restarting the application."""
        self.destroy()
        self.__init__()
    ...
    def append_to_chat(self, message, sender="robot"):
        ...
        self.chat_area.tag_config(tag_name, foreground="dark blue" if sender == 'robot' else "light blue")
    ...
    def initialize_environment(self):
        ...
        self.robot_control.start_camera_for_short_duration()  # Start the camera and take snapshots for a short duration
    ...
    def run_detection_and_segmentation(self):
        ...
        detected_image_path = os.path.join(output_directory, "segmented_annotated_image_20240508_180401.jpg")
