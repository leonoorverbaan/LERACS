...
## Download GroundingDINO: https://github.com/IDEA-Research/GroundingDINO.git 
cd $1/src
...
## Download Segment anything: https://github.com/facebookresearch/segment-anything.git
cd $1/src
